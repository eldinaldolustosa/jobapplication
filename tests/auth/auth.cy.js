...
describe('[AUTH] Authentication Layer — Cypress', () => {
  ...
  describe('POST /api/v1/auth/login', () => {
    ...
    it('US02-CY-002 | should return 401 for wrong password (anti-enumeration)', () => {
      cy.request({
        method: 'POST',
        url: `${BASE}/auth/login`,
    ...
    it('US02-CY-003 | should return same 401 message for non-existent email', () => {
      cy.request({
        method: 'POST',
        url: `${BASE}/auth/login`,
    ...
    it('US02-CY-004 | should return 400 with validation errors for missing email', () => {
      cy.request({
        method: 'POST',
        url: `${BASE}/auth/login`,
    ...
    it('US02-CY-005 | should return 400 with validation errors for missing password', () => {
      cy.request({
        method: 'POST',
        url: `${BASE}/auth/login`,
  ...
  describe('POST /api/v1/auth/refresh', () => {
    it('US02-CY-006 | should return 200 with new tokens for a valid refresh token', () => {
    ...
    it('US02-CY-007 | should return 401 for an invalid refresh token', () => {
      cy.request({
        method: 'POST',
        url: `${BASE}/auth/refresh`,
    ...
    it('US02-CY-008 | should return 400 when refreshToken field is absent', () => {
      cy.request({
        method: 'POST',
        url: `${BASE}/auth/refresh`,
        body: {},
